...
export const ACHIEVEMENTS_REGISTRY: Record<string, AchievementMeta> = {
  ...
  over_killer: {
    ...
    tierDescriptions: {
      bronze: 'Awarded for dealing a match-winning blow with 5+ excess overkill damage beyond zero life.',
      silver: 'Awarded for dealing a match-winning blow with 10+ excess overkill damage beyond zero life.',
      gold: 'Awarded for dealing a match-winning blow with 20+ excess overkill damage beyond zero life.',
    },
    criteria: {
      bronze: 'Final life drops to -5 or below (5+ excess overkill).',
      silver: 'Final life drops to -10 or below (10+ excess overkill).',
      gold: 'Final life drops to -20 or below (20+ excess overkill).',
    },
