      ...
      >
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar p-5 space-y-5">
            {/* Header card: deck name, larger color pips, prominent commander */}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 rounded-2xl border flex items-center justify-between" style={{ backgroundColor: palette?.surface, borderColor: palette?.border }}>
                ...
                <Trophy className="w-7 h-7 opacity-40" style={{ color: palette?.accent }} />
              </div>
              ...
              <div className="p-4 rounded-2xl border flex items-center justify-between" style={{ backgroundColor: palette?.surface, borderColor: palette?.border }}>
                ...
                <Layers className="w-7 h-7 opacity-40" style={{ color: palette?.accent }} />
              </div>
            </div>

            {/* Play / Draw: two distinct rows with win/loss bar continuum */}
            <div className="p-4 rounded-2xl border space-y-3" style={{ backgroundColor: palette?.surface, borderColor: palette?.border }}>
            ...
            {/* Placeholder note for Stage 2 charts */}
            <div className="p-4 rounded-2xl border border-dashed text-center text-xs font-mono opacity-40" style={{ borderColor: palette?.border }}>
              Charts (mana curve, card types, mana distribution, win-rate pie) arriving in Stage 2.
            </div>
          </div>

          {/* Right sidebar: thin recent matches list */}
          <div className="w-[260px] shrink-0 border-l flex flex-col" style={{ borderColor: palette?.border, backgroundColor: palette?.surface }}>
