...
const DEFAULT_COLUMNS: ColumnDef[] = [
  { key: 'matchup', label: 'Matchup', description: 'Player Deck vs Opponent (combined)', visible: true, width: 'flex-[2.5] min-w-[240px]', align: 'left' },
  { key: 'date', label: 'Date & Time', description: 'Match timestamp and relative time', visible: true, width: 'flex-[1.2] min-w-[120px]', align: 'center' },
  { key: 'result', label: 'Result', description: 'Win/Loss indicator and status badge', visible: true, width: 'flex-1 min-w-[95px]', align: 'center' },
  { key: 'format', label: 'Format', description: 'Game format badge', visible: true, width: 'flex-[1.2] min-w-[110px]', align: 'center' },
  { key: 'play_draw', label: 'Play', description: 'Opening turn position (Play / Draw)', visible: true, width: 'flex-1 min-w-[80px]', align: 'center' },
  { key: 'colors', label: 'Colors', description: 'Player deck mana color identity', visible: true, width: 'flex-1 min-w-[90px]', align: 'center' },
  { key: 'mana_curve', label: 'Mana Curve', description: 'Mini deck mana histogram', visible: true, width: 'flex-[1.2] min-w-[120px]', align: 'center' },
  { key: 'deck', label: 'Deck', description: 'Player deck artwork thumbnail and name', visible: false, width: 'flex-[2] min-w-[180px]', align: 'left' },
  { key: 'opponent', label: 'Opponent', description: 'Opponent username (click to filter)', visible: false, width: 'flex-[1.5] min-w-[140px]', align: 'left' },
  { key: 'game_stats', label: 'Game Stats', description: 'Turns elapsed and duration', visible: false, width: 'flex-1 min-w-[105px]', align: 'center' },
  { key: 'key_cards', label: 'Key Cards', description: 'Mini portraits of notable cards played', visible: false, width: 'flex-[1.1] min-w-[110px]', align: 'center' },
  { key: 'life_totals', label: 'Final Life', description: 'Ending life score (You - Opp)', visible: false, width: 'flex-1 min-w-[95px]', align: 'center' },
  { key: 'mulligans', label: 'Mulligans', description: 'Opening hand mulligans taken', visible: false, width: 'flex-[0.8] min-w-[85px]', align: 'center' },
